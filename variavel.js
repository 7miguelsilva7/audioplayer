...
// musicas
} else if (quebra[1]=="hinarioCantado") { document.write('<script type="text/javascript" src="playlists/musicHinarioCantado.js"><\/script>');
} else if (quebra[1]=="hinosSalmosCanticos") { document.write('<script type="text/javascript" src="playlists/musicHinosSalmosCanticos.js"><\/script>');
} else if (quebra[1]=="CanticosCantadoPorCrianca") { document.write('<script type="text/javascript" src="playlists/musicCanticosCantadoPorCrianca.js"><\/script>');
} else if (quebra[1]=="musicTudo") { document.write('<script type="text/javascript" src="playlists/musicTudo.js"><\/script>');
// end musicas
